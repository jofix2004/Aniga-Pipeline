...
WORK_DIR = os.environ.get("ANIGA_WORK_DIR", "/teamspace/studios/this_studio/Aniga_Work/imgcraft")
UPLOAD_DIR = os.path.join(WORK_DIR, "_uploads")
SAVE_DIR = os.environ.get("ANIGA_SAVE_DIR", "/teamspace/studios/this_studio/Aniga_Work/imgcraft/_output")
